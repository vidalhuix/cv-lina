export const WorkItem = ({ year, title, duration, details }) => {
    return (
      <ol className="flex flex-col md:row relative border-l-[2px] border-emerald-700">
        <li className="mb-10 ml-4">
          <div className="absolute w-3 h-3 rounded-full bg-emerald-700 mt-1.5 -left-1.5 border-white" />
          <p className="flex flex-wrap gap-4 flex-row items-center justify-start text-xs md:text-sm">
            <span className="inline-block px-2 py-1 font-semibold text-white bg-emerald-700 rounded-md">
              {year}
            </span>
            <span className="text-lg font-semibold text-gray-800 ">{title}
